...
print "Creating actual rays image"
...
# IMAGE WITH IMAGE RAYS

list1 = []
list2 = []
lenscounter = 0

print "Creating image rays image"
img = Image.new('RGB', (SIZE[0] * AAS, SIZE[1] * AAS), BLUE)
d = ImageDraw.Draw(img)

# ORIGIN LINES
print "---- Drawing origin lines"
d.line([-9000 + TRANSLATEX, 0 + TRANSLATEY, 20000 + TRANSLATEX, 0 + TRANSLATEY],  DARKGREY, 5)
d.line([0 + TRANSLATEX, 9999 + TRANSLATEY, 0 + TRANSLATEX, -9999 + TRANSLATEY],  DARKGREY, 5)
d.text([0 + TRANSLATEX + PADDING, 0 + TRANSLATEY + PADDING + 1000], "(0, 0)", DARKGREY, font)
d.text([0 + TRANSLATEX + PADDING, 0 + TRANSLATEY + PADDING + 1100], "ORIGIN", DARKGREY, font)
...
img.thumbnail(SIZE, Image.ANTIALIAS)
print "Saving Image"
img.save('C:\ilionData\Users\zeno.pelgrims\Documents\zoic_compile\lensDrawing_image.png','png')
# img.save('/Volumes/ZENO_2016/projects/zoic/tests/images/lensDrawing.png','png')
# img.save('/Users/kassiawordley/Desktop/zoic_kassia/lensDrawing.png','png')
