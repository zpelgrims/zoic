...
enum
{
   ...
   C4DAI_ZOIC_GENERAL_GRP                             = 3001,
   C4DAI_ZOIC_IMAGEBOKEH_GRP                          = 4001,
   C4DAI_ZOIC_RAYTRACED_GRP                           = 5001,
   C4DAI_ZOIC_THINLENS_GRP                            = 6001,
   C4DAI_ZOIC_EXTRA_GRP                               = 7001,
   ...
   C4DAIP_ZOIC_LENSMODEL                              = 819210154,
   C4DAIP_ZOIC_LENSDATAPATH                           = 819210155,
   C4DAIP_ZOIC_KOLBSAMPLINGLUT                        = 819210156,
   C4DAIP_ZOIC_USEDOF                                 = 1290326798,

   
   C4DAIP_ZOIC_OPTICALVIGNETTINGDISTANCE              = 158969043,
   C4DAIP_ZOIC_OPTICALVIGNETTINGRADIUS                = 819210157,
