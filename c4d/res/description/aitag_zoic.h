...
enum
{
   ...
   C4DAI_ZOIC_IMAGEBOKEH_GRP                          = ####,
   C4DAI_ZOIC_RAYTRACED_GRP                           = ####,
   C4DAI_ZOIC_THINLENS_GRP                            = ####,
   C4DAI_ZOIC_EXTRA_GRP                               = 4001,
   ...
   C4DAIP_ZOIC_LENSMODEL                              = ##########,
   C4DAIP_ZOIC_LENSDATAPATH                           = ##########,
   C4DAIP_ZOIC_KOLBSAMPLINGLUT                        = ##########,
   C4DAIP_ZOIC_USEDOF                                 = 1290326798,

   
   C4DAIP_ZOIC_OPTICALVIGNETTINGDISTANCE              = 158969043,
   C4DAIP_ZOIC_OPTICALVIGNETTINGRADIUS                = ##########,
